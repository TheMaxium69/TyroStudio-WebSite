...
<main>
    ...
    <main id="legal" style="margin-top: 30px">
        <section id="projet">
            <br>
        ...
        <section id="info">
            <div id="info" class="container" style="text-align: start;">
                <div style="text-align: center">
                    ...
                    <p><strong>TyroStudio est un projet appartenant à Tyrolium</strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-6 textmore">
                        ...
                        <small>- Bootstrap-5.3.3 </small><br>
                        <small>- JQuery-3.4.1</small><br>
                        <small>- Remixicon-4.2.0</small><br>
    ...
    <div class="section fp-auto-height"  data-anchor="end" style="
    margin-bottom: 68px;">
